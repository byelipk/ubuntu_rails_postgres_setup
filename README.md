...
__Let's go!__
	...
	Downloads from your host environment: 
	...
	VMWare Player Installation:
		...
		I installed the VM on an external hard drive. 
		My file structure looks like this: 		
	
			F:/VM
		
		VMWare Player, the vmplayer.exe, is installed inside the VM directory.

		Now you can install Ubuntu!
	...
	Ubuntu Virtual Machine set up:		
		...
		Ubuntu will install the first time you click 'Run.' This was a long
		process for me, but you will have a nice, clean, fresh Ubuntu install. Yay!
